...
set RAM[2100] -3,    // Set Arr[0]
set RAM[2101] -32768,   // Set Arr[1]
set RAM[2102] 3,    // Set Arr[2]
set RAM[2103] -100;     // Set Arr[3]
set RAM[2104] -1;     // Set Arr[4]
set RAM[2105] 0;     // Set Arr[5]
set RAM[2106] 0;     // Set Arr[6]
set RAM[2107] 32767;     // Set Arr[7]
set RAM[2108] -10;     // Set Arr[8]
set RAM[2109] 3235;     // Set Arr[9]
